...
zoom\&bound comes out as the best strategy of these, the GA shows some promise. 
...
\begin{enumerate}
    ...
    \item SHA-3 hash function, which is exploited here using algebraic fault analysis
...
\begin{algorithm}[!h]
    \begin{algorithmic}
        ...
        \REPEAT
            \FOR{$\mathit{individual} \in \mathit{population}$}
...
until~\ref{fig:ga3} depict intensity as a third parameter. For less clutter,
versions without NORMAL points are also provided. The random scan shown here
has a total of 3\,302 points; for the EA, the run with 3\,606 points is shown.
